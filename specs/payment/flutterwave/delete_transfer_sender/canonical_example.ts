...
interface DeleteTransferSenderInput {
  id: string;
  trace_id?: string;
}
...
export async function deleteTransferSender(
  input: DeleteTransferSenderInput
): Promise<void> {
...
await deleteTransferSender({
  id: "sender_12345abc",
});

// Sender is now deleted — subsequent get_transfer_sender calls return 404 NOT_FOUND
*/
